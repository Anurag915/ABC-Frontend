...
function VisionMissionGroup({ groupId }) {
  ...
  return (
    <div className=" mx-auto p-6 bg-white rounded-lg shadow-md border border-gray-200">
      <h2 className="text-3xl font-bold text-green-800 mb-6">Vision and Mission</h2>
      <section className="mb-6">
        <h3 className="text-xl font-semibold text-green-700 mb-2">Vision</h3>
        <p className="text-gray-700 leading-relaxed">{group.vision || "Vision statement not available."}</p>
      </section>
      <section>
        <h3 className="text-xl font-semibold text-green-700 mb-2">Mission</h3>
        <p className="text-gray-700 leading-relaxed">{group.mission || "Mission statement not available."}</p>
      </section>
    </div>
  );
}
