...
//       newErrors.cadre = "Cadre is required.";
...
//         className="w-full bg-white border border-gray-200 rounded-xl shadow-lg p-8 space-y-8"
//       >
...
//               required
//               placeholder="••••••••"
//               className="w-full p-3 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-300 transition"
//             />
//             <button
//               type="button"
//               onClick={() => setShowPassword((prev) => !prev)}
//               className="absolute inset-y-0 mt-6 right-3 flex items-center justify-center text-gray-500 hover:text-gray-800 focus:outline-none"
//             >
//               {showPassword ? (
